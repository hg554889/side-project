...
SITES_CONFIG = {
    ...
    'jobkorea': {
        ...
        'selectors': {
            ...
            'location': '.post-list-info .post-list-option li:first-child',
            'experience': '.post-list-info .post-list-option li:nth-child(2)',
            'salary': '.post-list-info .post-list-option li:last-child',
            'deadline': '.post-list-date',
            'url': '.post-list-corp-name a',
            'tags': '.post-list-keyword .chip-keyword',
            'category': '.post-list-job-category',
            'description': '.post-list-info .post-list-summary',
            'conditions': '.post-list-info .option'  # 두 번째 설정에서 가져온 필드
        },
        'rate_limit': 3.5,
        'max_pages': 8,
        'priority': 4
